    ...
    (function () {
        ...
        var _getWidgetInfo = function (elementId) {
            ...
            var widget = {
                ...
                isLayer: $ax.public.fn.IsLayer(obj.type)
            };
            ...
            widget.pagex = function () {
                return this.getProp('pagex');
            }
            widget.pagey = function () {
                return this.getProp('pagey');
            }
            ...
            widget.rotation = function () {
                return this.getProp('rotation');
            }
