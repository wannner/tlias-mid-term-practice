    ...
    $ax.messageCenter.addMessageListener(function (message, data) {
        ...
        if (message == 'switchAdaptiveView') {
            ...
            if (data.scale != 0) {
                ...
                if (adjustScrollScale) {
                    ...
                    _addNiceScroll($('html'), {
                        ...
                        cursorwidth: Math.ceil(6 / newScaleN) + 'px',
                        cursorborder: 1 / newScaleN + 'px solid #fff',
                        cursorborderradius: 5 / newScaleN + 'px'
                    });
                }
            }
            var contentScale = {
            ...
            if (data.device) {
                ...
                $(function () {
                    _setHorizontalScroll(!data.scaleToWidth);
                });
