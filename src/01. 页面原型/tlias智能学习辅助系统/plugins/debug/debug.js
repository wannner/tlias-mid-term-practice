    ...
    $(document).ready(function () {
        ...
        var processMessages = function (message, data) {
            if (message == 'globalVariableValues') {
                ...
                if (data.description) {
                    addToStack += "    <div class='axCaseDescription' title='" + data.description + "'>" + data.description + "</div>"
                }
                ;
                addToStack += "</div>";
                ...
                if (data.description) {
                    addToStack += "    <div class='axInfoDescription' title='" + data.longDescription + "'>" + data.description + "</div>"
                }
                ;
                addToStack += "</div>";
